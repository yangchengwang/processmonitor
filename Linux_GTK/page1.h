...
void page1Generate(void)
{
    ...
    gtk_label_set_markup(GTK_LABEL(authorInfo),"<span font_desc=\"Purisa Bold 23\" foreground=\"#000066\">Author: Vistb</span>\n<span font_desc=\"URW Chancery L 15\" style=\"italic\" foreground=\"#00AAAA\">HUST CSIS0601 Feb.2009\n Compile succeed under Fedora10 with kernel 2.6.27.12</span>");
